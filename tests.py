...
class TestCase(unittest.TestCase):
    ...
    def test_avatar(self):
        u = User(social_id='facebook$123', nickname='isccarrasco', email='krrask0@yahoo.com.mx')
        avatar = u.avatar(128)
        expected = 'http://www.gravatar.com/avatar/ac285a7b8fd34d0308792cfcde7a06f3'
    ...
    def test_follow(self):
        u1 = User(social_id='twitter$1234',nickname='john', email='john@example.com')
        u2 = User(social_id='twitter$1235',nickname='susan', email='susan@example.com')
        db.session.add(u1)
        db.session.add(u2)
        db.session.commit()
    ...
    def test_follow_posts(self):
        # make four users
        u1 = User(social_id='fb$1', nickname='john', email='john@example.com')
        u2 = User(social_id='fb$2', nickname='susan', email='susan@example.com')
        u3 = User(social_id='fb$3', nickname='mary', email='mary@example.com')
        u4 = User(social_id='fb$4', nickname='david', email='david@example.com')
        db.session.add(u1)
        db.session.add(u2)
        db.session.add(u3)
        db.session.add(u4)
